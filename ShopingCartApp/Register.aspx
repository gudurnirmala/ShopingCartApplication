...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div align="center">
        ...
        <dx:ASPxTextBox ID="tbFirstName" runat="server" Width="300px" Caption="First Name">
        ...
        <dx:ASPxTextBox ID="tbLastName" runat="server" Width="300px" Caption="Last Name">
            <CaptionSettings Position="Top" />
            <ValidationSettings ValidationGroup="RegisterUserValidationGroup" Display="Dynamic" ErrorTextPosition="Bottom" ErrorDisplayMode="Text">
        ...
        <dx:ASPxTextBox ID="tbUserName" runat="server" Width="300px" Caption="User Name">
            <CaptionSettings Position="Top" />
            <ValidationSettings ValidationGroup="RegisterUserValidationGroup" Display="Dynamic" ErrorTextPosition="Bottom" ErrorDisplayMode="Text">
        ...
        <dx:ASPxTextBox ID="tbConfirmPassword" Password="true" runat="server" Width="300px" Caption="Confirm password">
            <CaptionSettings Position="Top" />
            <ValidationSettings ValidationGroup="RegisterUserValidationGroup" Display="Dynamic" ErrorTextPosition="Bottom" ErrorDisplayMode="Text">
